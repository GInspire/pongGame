...
Void ApplicationMain_obj::main( ){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","ApplicationMain.hx",104,0x0780ded5)
				{
					...
					__result->Add(HX_HCSTRING("title","\x98","\x15","\x3b","\x10") , HX_HCSTRING("pongGame","\x0a","\xfc","\x9f","\x86"),false);
		...
		struct _Function_1_2{
			inline static Dynamic Block( Dynamic &tmp){
				...
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_HCSTRING("build","\x2e","\xdb","\xea","\xba") , HX_HCSTRING("64","\x3e","\x2f","\x00","\x00"),false);
					__result->Add(HX_HCSTRING("company","\x3d","\x15","\x69","\x83") , HX_HCSTRING("Anubha","\x13","\xf2","\xe6","\xa0"),false);
					__result->Add(HX_HCSTRING("file","\x7c","\xce","\xbb","\x43") , HX_HCSTRING("pongGame","\x0a","\xfc","\x9f","\x86"),false);
					__result->Add(HX_HCSTRING("fps","\xe9","\xc7","\x4d","\x00") , (int)60,false);
					__result->Add(HX_HCSTRING("name","\x4b","\x72","\xff","\x48") , HX_HCSTRING("pongGame","\x0a","\xfc","\x9f","\x86"),false);
					__result->Add(HX_HCSTRING("orientation","\xd0","\xee","\xfe","\xfd") , HX_HCSTRING("landscape","\x3b","\x78","\xad","\xfc"),false);
					__result->Add(HX_HCSTRING("packageName","\xf1","\x04","\xad","\x04") , HX_HCSTRING("com.pongGame.game","\xe9","\xcd","\xc1","\x34"),false);
